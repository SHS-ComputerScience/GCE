...
##print("")
##
##print("1. Pway Game owO")
##print("2. Instwuctions")
##print("3. Quit")
##
##choice = input("Sewect choice senpai: ")
##
##if choice == "1":
##    print("Lets Go!")
##if choice == "2":
##    print("Pwess 1 to pway or pwess 3 to quit")
